...
class LanguageSwitcher {
    ...
    loadTranslations() {
        ...
        this.translations.es = {
            ...
            aboutBackgroundText: "Desde que era pequeño, me ha apasionado la forma en que funciona el mundo. Recuerdo pasar horas explorando ideas, haciendo preguntas y disfrutando la emoción de resolver problemas, ya fueran problemas matemáticos o simplemente descifrar cómo encajan las cosas. Esa curiosidad constante me ha acompañado siempre y se ha convertido en mi fuerza motriz: me encanta aprender, descubrir nuevas perspectivas y encontrar belleza en el proceso de entender.\n\nYa en el colegio, mi amor por las matemáticas creció y se mezcló con una fascinación por los grandes desafíos, donde la paciencia y la creatividad van de la mano. Al mismo tiempo, la tecnología me empezó a atraer, no solo como una herramienta, sino como algo que constantemente remodela cómo vivimos, nos conectamos y entendemos el mundo. Todo esto me llevó de manera natural hacia el mundo de los datos: analizar información, comprender problemas y proponer soluciones que realmente ayuden a las personas es algo que me motiva enormemente.\n\nAdemás de mi lado más analítico, siempre me ha encantado relacionarme con otras personas. Soy muy social y disfruto muchísimo haciendo planes con amigos y familia, compartiendo momentos y creando recuerdos juntos. Trabajar en equipo es algo que me apasiona: creo que las mejores soluciones surgen cuando combinamos ideas y perspectivas distintas para alcanzar un mismo objetivo.\n\nY no puedo olvidarme del deporte, que ocupa un lugar muy importante en mi día a día. Me ayuda a mantenerme activo, a liberar energía y a aprender la importancia de la disciplina y la constancia, valores que trato de aplicar en todo lo que hago.\n\nEn definitiva, me considero alguien curioso, apasionado y social, siempre buscando aprender, crecer y disfrutar del camino, tanto en lo profesional como en lo personal.",
            ...
            aboutEducationDescription: "Actualmente cursando un programa integral que combina la informática tradicional con ciencia de datos e inteligencia artificial de vanguardia. Los contenidos abarcan desde principios de ingeniería de software hasta algoritmos avanzados de aprendizaje automático, análisis estadístico y procesamiento de big data.",
            ...
            aboutSkillsTableTechnology: "Tecnología",
            aboutSkillsTableSkillBar: "Nivel de Habilidad",
            aboutSkillsTablePercentage: "%",
            aboutSkillsTableLanguageName: "Idioma",
            aboutSkillsTableFluency: "Fluidez",
            aboutSkillsTableCEFR: "MCER",
